...
class PhysicalActivity {
  ...
  // Coordenadas GPS (início e fim para atividades com tracking)
  ...
  /// Verifica se esta atividade requer tracking GPS
  ...
  /// Verifica se tem dados GPS
  bool get hasGpsData => startLocation != null || endLocation != null;
  ...
  PhysicalActivity copyWith({
    ...
    int? caloriesBurned,
    String? notes,
    GpsTrackPoint? startLocation,
    GpsTrackPoint? endLocation,
  }) {
...
/// Ponto de tracking GPS
class GpsTrackPoint {
  final double latitude;
  final double longitude;
  final double? altitude;
  final DateTime recordedAt;
  final int sequence; // 1 = início, 2 = fim
  ...
  Map<String, dynamic> toJson(int activityId) {
    return {
  ...
  factory GpsTrackPoint.fromJson(Map<String, dynamic> json) {
    return GpsTrackPoint(
      latitude: (json['lat'] as num).toDouble(),
      longitude: (json['lng'] as num).toDouble(),
      altitude: (json['altitude_m'] as num?)?.toDouble(),
  ...
  @override
  String toString() => 'GpsTrackPoint(seq: $sequence, lat: $latitude, lng: $longitude)';
}
...
extension ActivityTypeExtension on ActivityType {
  ...
  /// Verifica se requer tracking GPS
